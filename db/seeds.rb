...
Category.create([{ label: 'Comedy'}, { label: 'Science Fiction'}, { label: 'Horrifying Unfunny Spoof'}])
  ...
  monk = Video.create(title: 'Monk Reviewed', description: "This is a video about a monk.", small_cover_url: "monk.jpg", large_cover_url: "monk_large.jpg", category_id: 3)
  
  # Seed a review  
  ralph = User.create(full_name: "Testy McTestor", email: "test@testy.test", password: "password")
  Review.create(user: ralph, video: monk, rating: 4, content: "This is a great movie.")
  Review.create(user: ralph, video: monk, rating: 2, content: "This is a great movie.")
  Review.create(user: ralph, video: monk, rating: 1, content: "This is a great movie.")
